...
public class DlgMostraVeiculos extends javax.swing.JDialog {
    ...
    private void exibeInformacoes(){
        ...
        for(int i = 0; i < veiculos.size(); i++){
            ...
            //novo
            tblVeiculos.setValueAt("", i, 3);
            
            //pegar valores de entrada e saida
            tblVeiculos.setValueAt("", i, 4);
            tblVeiculos.setValueAt("", i, 5);
            
        }
        
        for(int i = 0; i < veiculos.size() && veiculos.get(i)!= null; i++){
            tblVeiculos.setValueAt(veiculos.get(i).getTipo(), i, 0);
            tblVeiculos.setValueAt(veiculos.get(i).getVaga(), i, 1);
            tblVeiculos.setValueAt(veiculos.get(i).getPlaca(), i, 2);
            //novo
            tblVeiculos.setValueAt(veiculos.get(i).getEntrada(), i, 3);
            
            //mostrar valores na tabela de entrada e saida
            tblVeiculos.setValueAt(veiculos.get(i).getSaida(), i, 4);
            tblVeiculos.setValueAt(veiculos.get(i).getHorasEstacionado(),i, 5);
        }
    ...
    private void initComponents() {
        ...
        tblVeiculos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipo", "Vaga", "Placa", "Entrada", "Saida", "Duração em minutos"
            }
        ) {
